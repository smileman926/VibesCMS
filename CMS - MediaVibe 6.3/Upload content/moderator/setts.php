...
<div class="col-md-6 col-xs-12"> 
<div class="form-group form-material">
	<label class="control-label"><i class="icon-money"></i>Premium features</label>
	<div class="controls">
...
<div class="col-md-6 col-xs-12"> 
<div class="form-group form-material">
<label class="control-label"><i class="icon-arrows-h"></i>Payment details</label>
 <div class="controls">
<div class="row">
<div class="col-md-6">
...
<div class="col-md-6">
<input type="text" name="monthlycurrency" class="col-md-12" value="<?php echo get_option('monthlycurrency','USD'); ?>"><span class="help-block align-center">Currency code. <a href="https://developer.paypal.com/docs/classic/api/currency_codes/" target="_blank">Full list at PayPal</a></span>
</div>
</div>
</div>
</div>
...
<div class="col-md-6 col-xs-12"> 
<div class="form-group form-material">
<label class="control-label"><i class="icon-arrows-h"></i>Video thumbs resizing (Note: just image size, not container).</label>
 <div class="controls">
<div class="row">
<div class="col-md-6">
