...
<?php if($yFull < $vFull) { echo "<a href=\"https://www.phpvibe.com/recent-changes/\" target=\"_blank\"><strong class=\"redText\"> New update available! [Info]</strong></a>";} else {echo "<strong class=\"greenText\"> Up to date!</strong>";
...
echo '
<script>
$.getScript( "'.tpl().'styles/js/js-alert.js" )
  .done(function( script, textStatus ) {
    $.notify("New upgrade available [ v'.$vFull.' ]");;
  })
