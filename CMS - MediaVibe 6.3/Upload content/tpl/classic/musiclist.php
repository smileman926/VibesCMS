...
$st = '<div class="btn-group pull-right">
       <a data-toggle="dropdown" class="btn btn-pure dropdown-toogle"> <i class="icon icon-calendar"></i> <i class="icon icon-angle-down"></i> </a>
...
<ul class="nav nav-tabs nav-tabs-line mtop20">
                    <li class="<?php aTab(browse);?>" role="presentation"><a href="<?php echo music_url('browse'); ?>"> <i class="material-icons">&#xe01d </i> <?php echo _lang('Recent'); ?> </li></a>
                    <li class="<?php aTab(mostviewed);?>" role="presentation"><a href="<?php echo music_url(mostviewed); ?>"> <i class="icon icon-line-chart"></i> <?php echo _lang('Top'); ?></a></li>
                    <li class="<?php aTab(mostliked);?>" role="presentation"><a href="<?php echo music_url(mostliked); ?>"> <i class="material-icons">&#xe8dc </i> <?php echo _lang('Most Liked'); ?></a></li>
