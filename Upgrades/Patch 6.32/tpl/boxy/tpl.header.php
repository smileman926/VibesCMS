...
register_style('https://fonts.googleapis.com/css?family=Material+Icons|Roboto:300,400,500|Raleway:400');
...
if(!is_user()) {
$nav .= '	
<a id="uploadNow" data-target="#login-now" data-toggle="modal" href="javascript:void(0)" class="top-link" title="'._lang("Login to upload").'">	<i class="material-icons">&#xE2C6;</i> </a> 
...
$nav .= '<a id="notifs" href="'.site_url().'dashboard/?sk=activity" class="top-link"><i class="icon material-icons">notifications</i></a>	
';
if(get_option('showusers','1') == 1 ) {
$nav .=  '<a class="top-link" href="'.site_url().members.'/"><i class="material-icons">&#xE1BD;</i></a>';
}
$nav .= '<a id="openusr" class="btn btn-flat uav btn-small dropdown-toggle"  data-toggle="dropdown" href="#" aria-expanded="false"
