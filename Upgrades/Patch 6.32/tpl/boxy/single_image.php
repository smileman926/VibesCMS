...
<div class="row mediavibe-content">
    ...
    <div class="col-md-6 image-holder">
        <div class="the-image block full" style="position:relative">        
            <?php  do_action('before-image');
                   echo $embedimage; 
                   do_action('after-image');
            ?>
			<a class="rm_next tipS hide"  data-placement="right" href="#">
			<i class="material-icons">&#xE5C8;</i>
			</a>
			<a class="rm_prev tipS hide"  data-placement="left" href="#">
			<i class="material-icons">&#xE5C4;</i>
			</a>
        </div>
  ...
  <script>
 $(document).ready(function() {
if ($(".image-item.freshI").length) {
var NILink = $(".image-item.freshI:first").find("a.clip-link").attr("href");
var NITitle = $(".image-item.freshI:first").find("a.clip-link").attr("title");
