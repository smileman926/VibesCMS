...
//echo $tp;
$fp = ABSPATH.'/'.get_option('mediafolder','media')."/";
$folder = $fp;
$ip = ABSPATH.'/'.get_option('mediafolder','media').'/thumbs/';	;
/* Get sizes */
...
if((filesize($videocheck) < 15000) && !is_dir($videocheck) && !_contains($videocheck,'index') && !_contains($videocheck,'htaccess')){
