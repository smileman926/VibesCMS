...
if(($video->media) > 1) {
/* Load jPlayer for music */	
//jPlayer
add_filter( 'addplayers', 'jpsup' );  	
} else {
/* Load player for videos (uploaded and remote) */	
//JwPlayer
if((get_option('youtube-player') > 1 ) || ((get_option('remote-player',1) == 1) || (get_option('choosen-player', 1) == 1))) {
...
//VideoJS
if(((get_option('remote-player',1) == 6) && ($origin == 1)) || (get_option('choosen-player',1) == 6)|| (get_option('youtube-player',1) == 6))	{					 
