...
if(_EmbedMusic()) {	
$data .= '<li class="active"><a data-toggle="tab" href="#soundCloud" role="tab">'._lang("Soundcloud").'</a></li>';
}
if(_UpMusic()) {	
$data .= '<li class=""><a data-toggle="tab" href="#mp3up" role="tab">'._lang("Upload mp3").'</a></li>';
}
$data .= '</ul>';	
}
