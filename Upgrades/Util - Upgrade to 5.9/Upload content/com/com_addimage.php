...
function JustCapitalize(string) {
    ...
    $("#imgInp").change(function(e){
		...
		fname = imgname.replace(/[^a-z0-9\s]/gi, \' \').replace(/[_\s]/g, \' \');
		fname = JustCapitalize(fname);
		$("#title").val(fname);
		$("#description").val(fname);
		var arrfname = fname.replace(/\s+/g, \',\').toLowerCase();
...
$data =  $error.'
   <div class="clearfix vibe-upload row block">			
	<div class=" well mright20 mleft20 mtop20">
