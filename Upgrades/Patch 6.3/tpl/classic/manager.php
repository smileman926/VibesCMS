...
<?php } ?>
 ...
 <label></label> Select all
	...
	<?php foreach ($videos as $video) { ?>    
		 ...
		 <div class="segment"> 
		 <div class="btn-group">     
		 <a class="btn  btn-pure " href="<?php echo site_url().me;?>?sk=edit-video&vid=<?php echo $video->id;?>" title="<?php echo _lang("Edit"); ?>"><i class="icon-pencil" style=""></i></a>     
		 <a class="btn  btn-pure " href="<?php echo site_url().me;?>?sk=videos&p=<?php echo this_page();?>&delete-video=<?php echo $video->id;?>" title="<?php echo _lang("Unpublish"); ?>"><i class="icon-trash" style=""></i></a> 
		 </div>  
		 </div> 
		 </div>
	 <?php } ?>        
...
<?php $images = $db->get_results("select id,title,thumb, views, liked from ".DB_PREFIX."images where user_id ='".user_id()."' and pub > 0 ORDER BY ".DB_PREFIX."images.id DESC ".this_limit().""); 
 ...
 <div class="item-in-list list-header">     
	...
	<div class="content--items"> <?php foreach ($images as $image) { ?> 
		 ...
		 <a class="btn btn-sm btn-pure " href="<?php echo site_url().me;?>?sk=images&p=<?php echo this_page();?>&delete-image=<?php echo $image->id;?>" title="<?php echo _lang("Unpublish"); ?>">    <i class="icon-trash" style=""></i></a> 
		 </div>  
		 </div> 
		</div>
	<?php } ?>     
...
<div class="item-in-list list-header">     
  ...
  <div class="segment">  
	...
	<div class="content--items"> <?php foreach ($images as $image) { ?> 
	 ...
	 <div class="segment"> 
	 <div class="btn-group"> 
	 <a class="btn btn-sm btn-pure " href="<?php echo site_url().me;?>?sk=hearts&p=<?php echo this_page();?>&delete-heart=<?php echo $image->id;?>" title="<?php echo _lang("Remove rating"); ?>"> <i class="icon-trash" style=""></i> </a> 
	 </div>  
	 </div> 
		</div>
	<?php } ?>
...
<div class="item-in-list list-header">     
  ...
  <div class="segment">  
	...
	<div class="content--items">   
		 ...
		 <div class="segment">     
		 <a class="btn btn-sm btn-pure " href="<?php echo site_url().me;?>?sk=playlists&p=<?php echo this_page();?>&delete-playlist=<?php echo $video->id;?>" title="<?php echo _lang("Delete playlist"); ?>"><i class="icon-trash"></i></a> 
		 </div> 
		 </div>
		 <?php } ?> 
	</div>   
...
<div class="item-in-list list-header">     
  ...
  <div class="segment">  
	...
	<div class="content--items">
		 ...
		 <div class="segment"> 
		 <a class="btn btn-sm btn-pure " href="<?php echo site_url().me;?>?sk=albums&p=<?php echo this_page();?>&delete-playlist=<?php echo $album->id;?>" title="<?php echo _lang("Delete playlist"); ?>"> <i class="icon-trash"></i> </a>         
		 </div> 
	     </div>
		<?php } ?> 
	</div>   
  ...
  <div class="segment">  
	...
	<div class="content--items"> 
		<?php foreach ($images as $video) { ?> 
		 ...
		 <div class="segment"> 
		 <a class="btn btn-sm btn-pure" href="<?php echo site_url().me;?>?sk=manage-albums&album=<?php echo _get("album");?>&remove=<?php echo $video->id;?>"> <i class="icon-trash" style=""></i> </a>          
		 </div> 
		 </div>
		  <?php } ?>  
	</div>   
