...
<div class="row">
<div class="col-md-6">
<input type="text" name="ffmpeg-thumb-time" class="col-md-12" value="<?php echo get_option('ffmpeg-thumb-time','00:00:03'); ?>">
...
<h3>Video qualities</h3>
 <div class="form-group form-material">
	...
	<div class="controls">
	<input type="text" id="tags" name="ffmeg-qualities" class="tags col-md-12" value="<?php echo get_option('ffmeg-qualities','360,480'); ?>">
	</div>
...
$qualities = array(240,360,480,720,1080,1440,2160);
