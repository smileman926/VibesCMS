...
<link rel="stylesheet" href="'.admin_url().'css/bootstrap.min.css">
    ...
    <link href=\'//fonts.googleapis.com/css?family=Raleway:300|Roboto:400,500,700&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic\' rel=\'stylesheet\' type=\'text/css\'>
    ';
}
function admin_h(){
$head= '
		  ...
		  <ul>
           <li class="LiHead"> <a href="#"><i class="icon-cogs"></i> Settings</a>
                   <ul>
					...
					<li> <a  href="'.admin_url('unvideos').'"><i class="icon-trash"></i>Unpublished</a></li>
					</ul>
                  </li>
                <li class="LiHead">
