...
if ($('.fp-player').html()) {	
$('.fp-player').prepend('<a class="fp-logo" href="'+ thelink +'"><img src="'+ thelogo +'"/></a>');	
$('.plAd').detach().appendTo('.fp-player');	
$('.bAd').detach().appendTo('.fp-player');
