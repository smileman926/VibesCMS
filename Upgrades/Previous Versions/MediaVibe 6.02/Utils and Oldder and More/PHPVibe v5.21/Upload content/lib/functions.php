...
$lang_file = INC.'/langs/'.$lang_code.'.json';
//echo $lang_file;
...
@chmod(INC.'/langs/', 0777);
$lang_file = INC.'/langs/'.$code.'.json';
@touch($lang_file);
