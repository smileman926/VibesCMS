...
$heading_meta = '';
$heading_meta .= '
<div class="media row right20 left10 playlist-head">
...
if($playlist->ptype ==1) {
$heading_meta .= '
<a class="btn btn-direction btn-left btn-primary tipN pull-right" title="'._lang("Play all").'" href="'.site_url().'forward/'.$playlist->id.'/"><i class="icon icon-play-circle"></i>'._lang("Play all videos in this collection").'</a>
';
}
$heading_meta .= '
