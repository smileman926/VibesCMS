...
<div class="row">
    <div class="col-md-7 image-holder">
        ...
        <div class="the-image block full">
            <div class="block img-helpers">
                <div class="inline" style="position:relative;">
                    <a class="btn btn-icon btn-danger btn-outline" href="javascript:iHeartThis(<?php echo $image->id; ?>)">
                        <i class="icon icon-heart"></i>
                    </a>
                </div>
                <div class="inline" style="position:relative;">
                    <a class="btn btn-icon btn-primary btn-outline" data-toggle="dropdown" data-target="#" class="dropdown-toogle dropdown-left tipS" title="<?php echo _lang('Add to album');?>">
                        <i class="icon-plus"></i>
                    </a>
    ...
    <div class="col-md-5 img-sidebar">
        ...
        <div class="block full img-inner odet">
            ...
            <h1><?php echo _html($image->title);?> </h1>			
			...
			<li>
			<div class="block full text-right"><i class="icon icon-heart mright10"></i><span class="mright20 right10"><?php echo $image->liked;?></span>
