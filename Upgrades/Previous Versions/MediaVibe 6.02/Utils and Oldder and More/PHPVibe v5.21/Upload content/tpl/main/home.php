...
do_action('home-end');
echo _ad('0','home-end');
echo '<div class="row top20 bottom20 text-center">
<a href="'.list_url(browse).'" class="btn btn-outline btn-default"><i class="icon-play-circle"></i> '._lang('Browse library').'</a>
</div>
';
?>
</div>
