...
<img class="img-responsinve" style="max-height:200px;" id="targetImg" src="<?php echo thumb_fix(user_avatar());?>" />
</div>
...
<div class="block mtop20">
<button class="btn btn-block btn-direction btn-up btn-primary" type="submit"><?php echo _lang("Update"); ?></button>
</div>
</div>
</form>
</div>
...
<span class="input-group-addon"><i class="icon icon-facebook"></i></span>
...
<a href="https://www.facebook.com" target="_blank" title="<?php echo _lang("To Facebook"); ?>" class="btn btn-icon social-facebook tipS tooltip-scale" data-placement="left"><i class="icon icon-facebook bd-facebook"></i> </a>
</span>
</div>
</div>
<div class="form-group form-material floating">
<div class="input-group">
<span class="input-group-addon"><i class="icon icon-google-plus"></i></span>
<div class="form-control-wrap">
...
<span class="input-group-btn">
<a href="https://plus.google.com/" target="_blank" title="<?php echo _lang("To Google+"); ?>" class="btn btn-icon social-google-plus tipS tooltip-scale" data-placement="left"><i class="icon icon-google-plus bd-google-plus"></i> </a>
</span>
</div>
</div>
<div class="form-group form-material floating">
<div class="input-group">
<span class="input-group-addon"><i class="icon icon-instagram"></i></span>
<div class="form-control-wrap">
...
<span class="input-group-btn">
<a href="http://www.instagram.com" target="_blank" title="<?php echo _lang("To Instagram"); ?>" class="btn btn-icon social-instagram tipS tooltip-scale" data-placement="left"><i class="icon icon-instagram bd-instagram"></i> </a>
</span>
</div>
</div>
<div class="form-group form-material floating">
<div class="input-group">
<span class="input-group-addon"><i class="icon icon-twitter"></i></span>
<div class="form-control-wrap">
...
<span class="input-group-btn">
<a href="http://www.twitter.com" target="_blank" title="<?php echo _lang("To Twitter"); ?>" class="btn btn-icon social-twitter tipS tooltip-scale" data-placement="left"><i class="icon icon-twitter bd-twitter"></i> </a>
</span>
</div>
</div>
<div class="block mtop20">
