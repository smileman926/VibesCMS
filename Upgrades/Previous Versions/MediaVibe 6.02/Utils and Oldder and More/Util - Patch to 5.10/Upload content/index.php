...
if (!isset($killcache)) {
$a = (empty($a) || ($a == "") ) ? preg_replace("/[^a-z0-9]+/","-",strtolower($_SERVER['REQUEST_URI'])) : "home";
/* Exclude specific pages */
if((strpos($a,'register') == false) && (strpos($a,'login') == false) && (strpos($a,'moderator') == false) && (strpos($a,'setup') == false) && !isset($_GET['clang'])) {
