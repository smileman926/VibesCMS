...
echo '<li class="list-group-item"><i class="icon-fire-extinguisher redText"></i>Fullcache folder (/cache/html)is not writeable</li>';
} else {
echo '<li class="list-group-item"><i class="icon-check greenText"></i>Full cache is ok.</li>';
}
if (!is_writable(INC.'/langs')) {
echo '<li class="list-group-item"><i class="icon-fire-extinguisher redText"></i>Languages folder (/lib/langs)is not writeable. Langs can\'t be edited. <em>(This is not an issue if is not writeable for security reasons)</em>.</li>';
} else {
