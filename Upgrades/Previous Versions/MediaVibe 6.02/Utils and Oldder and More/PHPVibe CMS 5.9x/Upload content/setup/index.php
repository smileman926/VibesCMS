...
$test = phpVibeKey;
if(empty($test) || is_null($test) || ($test == "key goes here")) {
...
<div style="display:block;padding:2%"><img src="http://www.phpvibe.com/forum/Themes/citiez/images/custom/logo.png"></div>
Quick links:
<a style="display:inline-block; padding:2%;" target="_blank" href="http://www.phpvibe.com/installing-phpvibe/">Installing PHPVibe</a>
<a style="display:inline-block; padding:2%;" target="_blank" href="http://www.phpvibe.com/forum/">Support</a>
</div>
<div class="row">
<h2>Step 1</h2>
<?php $error = 0;
if(isset($db->errors) &&( !is_null($db->errors) && !empty($db->errors))) {
...
<div class=\"panel-heading\">PHPVibe license warning</div> 
<div style=\"padding:30px;\">
Please add the correct license key for domain ".get_domain(SITE_URL)." under vibe_config.php <br />
<a href=\"http://get.phpvibe.com/licenses\" target=\"_blank\">Browse to : My Licenses</a> <br />
Important! Common issues are: adding http://, www., subdomains, end slash, etc to the main domain when creating the key. <br />
Make sure the domain is in clear at our licensing system: ".get_domain(SITE_URL)." 
</div>
</section>
";
_error();
...
if(hasA_license()) {
echo '<div class="msg-win">License key exists</div>';
}
...
@chmod(ABSPATH.'/cache/html', 0777);
if (!is_writable(ABSPATH.'/cache/html')) {
echo '<div class="msg-warning">Static pages cache ('.ABSPATH.'/cache/html) is not writeable</div>';
_error();
} else {
echo '<div class="msg-win">Static pages cache ('.ABSPATH.'/cache/html) is writeable</div>';
}
