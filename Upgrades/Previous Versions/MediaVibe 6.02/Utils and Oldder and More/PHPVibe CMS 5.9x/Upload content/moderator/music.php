...
echo '<div class="msg-info">Song #'.$id.' was featured.</div>';
}
} 
...
echo '<div class="msg-info">Songs #'.implode(',', $_POST['checkRow']).' unpublished.</div>';
}
                          ...
                          <thead>
                              <tr>
                                 <th>
								  ...
								  </th>                                 <th width="19"><button class="btn btn-default btn-mini tipS" type="submit" title="<?php echo _lang("Unpublish all selected"); ?>"><i class="icon-trash"></i></button></th>
...
<li role="presentation"><a class="confirm" target="_blank" title="<?php echo _lang("Delete user"); ?>" href="<?php echo admin_url('users');?>&p=<?php echo this_page();?>&delete-user=<?php echo $video->user_id;?>"> <i class="icon icon-trash"></i> <span style="color:#f96868; font-weight:bold">Delete uploader </span> </a></li>
</ul>
</div>
								  </td>
								  ...
								  <p><a  class="tipS" title="<?php echo _lang("Not featured. Click to feature"); ?>" href="<?php echo canonical(); ?>&feature-video=<?php echo $video->id;?>"><i class="icon-star"></i></a></p>
								 <?php } else { ?>
								  <p><a class="tipS" title="<?php echo _lang("Featured! Click to remove"); ?>" href="<?php echo canonical(); ?>&unfeature-video=<?php echo $video->id;?>"><i class="icon-star greenSeaText"></i></a></p>
								 <?php } ?>
