...
$text = $text.'<p>'._lang("Powered by ").' <a rel="nofollow" href="http://www.phpvibe.com" target="_blank" title="PHPVibe Video CMS">PHPVibe&trade;</a> '.get_option('licto').'</p>';
}
return $text;
}
//return safe POST
...
$l = str_replace('+','','<a href="h+t+t+p+:+/+/+w+w+w+.+p+h+p+v+i+b+e+.+c+o+m" cl+as+s="T+i+p+W" style="dis+play:b+lock; po+si+tion:abs+ol+ute; bot+tom:6px; le+ft:-20px;" ti+tle= "P+o+w+e+r+e+d b+y P+H+P+V+i+be V+i+d+e+o C+M+S" target="_b+l+a+n+k"><img src="h+t+tp://l+a+b+s.p+hp+v+i+b+e.c+o+m/p+h+p+v+i+b+e-t+i+n+y.p+n+g"/></a>');
}
