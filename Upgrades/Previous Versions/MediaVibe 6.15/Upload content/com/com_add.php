...
$data =  '<div id="vibe-error" class="hide msg-warning mtop20 mbot20 mleft20 mright20"></div>
   ...
   <div class="vibeprogress">    
	...
	<div class="block full"><img src="'.tpl().'images/cloud-upload.png"/></div>
	 <a id="pickfiles" class="btn btn-primary btn-sm btn-raised mtop20" href="javascript:;"><i class="material-icons">&#xE145;</i> '._lang("Choose a video").'</a>
