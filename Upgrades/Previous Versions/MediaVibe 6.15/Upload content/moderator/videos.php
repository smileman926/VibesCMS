...
<small>Filter</small>
	<ul class="dropdown-menu dropdown-right bullet" role="menu">
		...
		<li role="presentation"><a title="Show youtube only" href="<?php echo add_sort('youtube');?>"><i class="material-icons icon">&#xE3D6;</i> Youtube only</a></li>
		</ul>
</a>
</h3> 
...
<ul class="list-group">
	...
	<?php } ?>
	 ...
	 <div class="btn-group btn-group-vertical pull-right">
		<a class="btn btn-sm btn-outline btn-default confirm" href="<?php echo admin_url('videos');?>&p=<?php echo this_page();?>&delete-video=<?php echo $video->id;?>">
