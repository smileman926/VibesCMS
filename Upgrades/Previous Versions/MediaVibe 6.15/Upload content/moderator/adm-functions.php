...
<head>
    <meta charset="utf-8">
    <title>MediaVibe 6 - Dashboard</title>
...
function acjs(){
$txt = '>p/<.>a/<6 ebiVaideM>"SMC oediV 6 ebiVphp"=eltit "knalb_"=tegrat "moc.ebivphp.www//:sptth"=ferh "wollofon"=ler a< yb derewoP>";xp01:pot-gniddap ;kcolb:yalpsid"=elyts p< >"tnetnoc-retoof 8naps"=ssalc vid<';
echo strrev($txt);
}
