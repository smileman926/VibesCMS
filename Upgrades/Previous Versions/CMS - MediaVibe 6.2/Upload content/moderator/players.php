...
<?php if(get_option('player-logo')) { ?><p><img src="<?php echo thumb_fix(get_option('player-logo')); ?>"/> <br /> <a href="<?php echo admin_url('players');?>&ac=remove-logo">Remove</a></p><?php } ?>
	...
	<span class="help-block" id="limit-text">Note: Hiding it with PHP may create issues on some devices. Please test first!</span>
	</div>
	</div>
	<div class="form-group form-material">
	<label class="control-label"><i class="icon-play"></i>Default Player <br /> <i>HTML5</i></label>
	<div class="controls">
	<label class="radio inline"><input type="radio" name="choosen-player" class="styled" value="6" <?php if(get_option('choosen-player') == 6 ) { echo "checked"; } ?>>VibesJs <small>(VideoJS variation)</small></label>
	<label class="radio inline"><input type="radio" name="choosen-player" class="styled" value="1" <?php if(get_option('choosen-player') == 1 ) { echo "checked"; } ?>>JwPlayer 7</label>
	...
	<div class="controls">
	<label class="radio inline"><input type="radio" name="remote-player" class="styled" value="6" <?php if(get_option('remote-player') == 6 ) { echo "checked"; } ?>>VibesJs</label>
	...
	<label class="radio inline"><input type="radio" name="youtube-player" class="styled" value="3" <?php if(get_option('youtube-player') == 3 ) { echo "checked"; } ?>>VibesJs</label>
