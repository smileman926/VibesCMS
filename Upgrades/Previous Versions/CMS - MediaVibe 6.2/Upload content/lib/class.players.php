...
$vjs = ' <script src="'.site_url().'lib/players/vibejs/vibejs.music.js"></script>'. PHP_EOL;
return $ini.$vjs;	
}
function vjsup($ini = ''){
$vjs = '<link rel="stylesheet"  href="' . site_url() . 'lib/players/vibejs/vibejs.player.css" />'. PHP_EOL;
$vjs .= '<script src="//imasdk.googleapis.com/js/sdkloader/ima3.js"></script>'. PHP_EOL;
$vjs .= ' <script src="' . site_url() . 'lib/players/vibejs/video.js"></script>'. PHP_EOL;
$vjs .= ' <script src="' . site_url() . 'lib/players/vibejs/vibe.plugins.js"></script>'. PHP_EOL;
return $ini.$vjs;
}
/* JwPlayer assets */
...
*/
 ...
 function vjsplayer($file, $thumb, $logo = null, $type = '', $extra = '')
    ...
    $ads   = _vjsads();
    $embed = '<video muted autoplay id="tvideo" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" poster="' . $thumb . '" data-setup=\'{"controls": true, "autoplay": true, "fluid": true, "aspectRatio": "16:9", "errorDisplay": false, "resizeManager": false,  "muted": true,  "playbackRates": [0.5, 1, 1.5, 2]}\'>';
