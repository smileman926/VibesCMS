...
<div class="col-md-6 col-xs-12"> 
<div class="form-group form-material">
<label class="control-label"><i class="icon-arrows-h"></i>Video thumbs resizing (Note: Thumb image size, not thumb size).</label>
 <div class="controls">
<div class="row">
<div class="col-md-6">
...
<div class="col-md-6 col-xs-12"> 
	...
	<label class="radio inline"><input type="radio" name="RelatedSource" class="styled" value="0" <?php if(get_option('RelatedSource','0') <> 1 ) { echo "checked"; } ?>> Match related</label>
...
<div class="col-md-6 col-xs-12"> 
<div class="form-group form-material">
	<label class="control-label"><i class="icon-bar-chart"></i> Tracking id (UA-....)</label>
	<div class="controls">
	<input type="text" id="googleanalitycs" name="googleanalitycs" class="auto col-md-12" value="<?php echo get_option('googleanalitycs'); ?>"\>
	<span class="help-block" id="limit-text">Paste your Google Analytics in full (UA-xxxxxx)</span>
	</div>
	</div>
	</div>
<div class="col-md-6 col-xs-12"> 
...
<div class="col-md-6 col-xs-12"> 
	...
	<span class="help-block" id="limit-text">Youtube type suggestions for the search box</span>
	</div>
	</div>
	</div>
	<div class="col-md-6 col-xs-12"> 
