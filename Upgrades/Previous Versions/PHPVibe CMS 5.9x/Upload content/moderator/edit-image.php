...
$db->query("UPDATE  ".DB_PREFIX."images SET liked='".toDb(_post('likes'))."',views='".toDb(_post('views'))."',privacy='".toDb(_post('priv'))."',title='".toDb(_post('title'))."', description='".toDb(_post('description') )."', category='".toDb(intval(_post('categ')))."', tags='".toDb(_post('tags') )."', nsfw='".intval(_post('nsfw') )."' WHERE id = '".intval($_POST['edited-image'])."'");
...
<div class="form-group form-material">
<label class="control-label">Image <br/>
<img src="<?php echo thumb_fix($image->thumb); ?>" style="max-width:150px; max-height:80px; margin-bottom:5px;"/>
