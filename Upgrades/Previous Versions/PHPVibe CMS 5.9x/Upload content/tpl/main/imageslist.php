...
<ul class="nav nav-tabs nav-tabs-line mtop20">
	...
	<?php if(_UpImage()) { ?>
	<li class="pull-right" role="presentation"><a href="<?php echo site_url().upimage; ?>"> <i class="icon icon-plus-square text-success"></i> <?php echo _lang('Add image'); ?></a></li>
    <?php } ?>
</ul>
<div id="imagelist-content">
...
<?php if(!is_ajax_call()) { echo the_nav(3); }; ?>
</div>
</div>
