...
if($md->nr > 0) {
$vq = "select date,".$options.", '".$profile->name."' as owner FROM ".DB_PREFIX."videos WHERE pub > 0 and date < now() and media > 1 and user_id ='".$profile->id."' ORDER BY id DESC ".this_limit(bpp());
