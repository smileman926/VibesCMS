...
<ul class="nav nav-tabs nav-tabs-line mtop20">
	                ...
	                <li class="pull-right" role="presentation"><a href="<?php echo site_url().upmusic; ?>"> <i class="icon icon-cloud-upload"></i> <i class="icon icon-soundcloud"></i> <?php echo _lang('Add song'); ?></a></li>
                   <?php } ?>
				 </ul>
...
<?php if(!is_ajax_call()) { echo the_nav(2); }; ?>
</div>
</div>
