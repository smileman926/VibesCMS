...
if(!bootsloaded) {
$.getScript("'.tpl().'styles/js/bootstrap.js");	
}
</script>
...
<script type="text/javascript" src="'.tpl().'styles/js/toastr.min.js"></script>
...
<script type="text/javascript" src="'.tpl().'styles/js/jssocials.min.js"></script>
